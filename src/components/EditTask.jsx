        ...
        <div className='flex flex-col lg:flex-row lg:justify-between'>
          <div 
            ...
            { !this.state.showTitleInput ? 
              ...
              : 
              <div className='flex flex-col lg:flex-row bg-grey-lighter p-1'>
                <input
                  onChange={ (e) => this.setState({ title: e.target.value}) }
                  className='input focus:outline-none rounded'
                ...
                <button 
                  onClick={ (e) => e.stopPropagation() || this.setState({showTitleInput: false }) } 
                  className='mx-2 text-smoke text-sm'>
                  Cancel
                </button> 
              </div> }
          </div>
        ...
        <div 
          ...
          { !this.state.showDescriptionInput ?
            ...
            <div className='flex flex-col lg:flex-row'>
              ...
              <button 
                onClick={ (e) => e.stopPropagation() || this.setState({ showDescriptionInput: false })} 
                className='mx-2 text-smoke text-sm'>
                Cancel
              </button> 
            </div> 
